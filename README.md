...
| [bytedance/deer-flow](https://github.com/bytedance/deer-flow/pull/5101) | 1 个 PR：RunManager 终态记录回收与幂等重用防泄漏 · Terminal-run record eviction with leak-free idempotent reuse |
